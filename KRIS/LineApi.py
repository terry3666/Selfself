# -*- coding: utf-8 -*-
from kris1 import Poll, Talk, channel
...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
              ...
              'User-Agent': 'Line/6.0.0 iPad4,1 9.0.2'#'Line/8.0.0'#'Line/7.18.0 AppleWebKit/534.30'#'Line/6.0.0 iPad4,1 9.0.2'#'Line/7.18.0 iPad4,1 9.0.2'
   }
